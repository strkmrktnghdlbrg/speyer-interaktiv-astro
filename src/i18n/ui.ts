...
export const ui = {
  ...
  "privacy.generalBody": {
    de: "Beim Aufrufen unserer Website werden durch unseren Hosting-Provider automatisch Informationen allgemeiner Natur erfasst: Browsertyp, Betriebssystem, Datum und Uhrzeit des Zugriffs sowie die IP-Adresse in gekürzter Form. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse).",
  ...
  "privacy.rightsContact": {
    de: "Zur Ausübung genügt eine formlose Nachricht an {email}.",
  ...
  "privacy.lastUpdatedBody": {
    de: "Diese Datenschutzerklärung wurde zuletzt im Mai 2026 überarbeitet.",
